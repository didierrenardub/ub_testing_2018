...
public class CStudentStatistics2018 extends CStudentStatistics
{
    public CStudentStatistics2018()
    {
        ...
        gabl.gradeClass(2, 1, 0, 0, 0, 0, 0, 1);
        gabe.gradeClass(2, 10, 10, 10, 10, 10, 10, 1);
        seba.gradeClass(2, 1, 0, 0, 0, 0, 0, 1);
